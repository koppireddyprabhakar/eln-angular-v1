...
@Component({
  selector: 'app-test-req-forms',
  templateUrl: './test-req-forms.component.html',
  styleUrls: ['./test-req-forms.component.css']
})
export class TestReqFormsComponent implements OnInit {
