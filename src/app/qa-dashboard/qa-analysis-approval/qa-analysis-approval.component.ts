...
@Component({
  selector: 'app-qa-analysis-approval',
  templateUrl: './qa-analysis-approval.component.html',
  styleUrls: ['./qa-analysis-approval.component.css']
})
export class QaAnalysisApprovalComponent implements OnInit {
  ...
  updateCoaReviewDetails() {
    ...
    this.experimentService.updateAnalysisCoaAprovalDetails(coareviewdetails).subscribe((data) => {
