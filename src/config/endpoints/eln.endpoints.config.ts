...
export const elnEndpointsConfig: EndpointConfig = {
  endpoints: {
    ...
    getProjectsTeamsId: `${environment.API_BASE_PATH}` + '/formulation-dashboard/get-projects-by-dosage-or-team-id',
    ...
    getFormulationProjectsTeamsId:
      `${environment.API_BASE_PATH}` + '/formulation-dashboard/get-projects-by-dosage-or-team-id',
    ...
    updateExperiment: `${environment.API_BASE_PATH}` + '/experiment/update-experiment',
    ...
    getExperimentsById: `${environment.API_BASE_PATH}` + '/formulation-dashboard/get-experiments-by-user-id',
    ...
    updateAnalysis: `${environment.API_BASE_PATH}` + '/analysis/update-analysis',
    ...
    getAnalysisIdByExperimentid: `${environment.API_BASE_PATH}` + '/analysis/get_analysis_details_by_experiment_id'
